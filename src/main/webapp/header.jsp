		...
		<nav
			...
			<div class="collapse navbar-collapse justify-content-between"
				...
				<div class="navbar-nav ml-auto py-0">
					...
					if (u == null) {
					%>
					<a href="signup.jsp" class="nav-item nav-link">signup</a> <a
						href="login.jsp" class="nav-item nav-link">login</a>
					<%
					} else {
					%>
					<a href="logout.jsp" class="nav-item nav-link">logout(<%=u.getName()%>)</a>
					<a href="change-password.jsp" class="nav-item nav-link">change password</a>
					<%
					}
					%>
				</div>
